...
public class AgenteIniciante extends Agent implements IAgente{
	...
	protected void setup() {
		...
		System.out.println("Ol�! O agente "+getAID().getName()+" est� pronto para buscar cupons.");
	...
	protected void takeDown() {
		System.out.println("Agente "+getAID().getName()+" j� esgotou suas prefer�ncias e ser� finalizada.");
	}
	...
	private class RequestPerformer extends Behaviour {
		...
		private int repliesCnt = 0; // N�mero de respostas de vendedores
		...
		private void passoAvaliarReputacao() {
			...
			if(replyInform != null){
				...
				System.out.println(myAgent.getLocalName()+" Analisando reputa��o");
				try {
